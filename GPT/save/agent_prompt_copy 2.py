...
Method 3: Image generation + 3D reconstruction
  ...
  Strengths: Excellent for adding detail or creating partial elements of a scene, especially adding a group of objects on the top of a furniture.(e.g., completing a room corner or enriching a tabletop).
