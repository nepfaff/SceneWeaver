import requests
import base64
from digital_cousins.models.TongGPT import TongGPT,GPT4o,GPT4V
...
class GPT(GPT4o):
    ...
    def payload_get_object_caption(self, img_path, tabletype):
        """
        ...
        # tabletype = "tv_stand"
# "4. When captioning, you can use broader categories. For instance, you can simply specify 'table' instead of 'short coffee table'.\n\n" + \
        prompting_text_system = "You are an expert in image captioning. " + \
                            "### Task Description ###\n\n" + \
                            f"The user will give you an image of a suppoter in the category of {tabletype}"+\
                            f"and please provide a list of all objects ([object1, object2, ...]) on the top of {tabletype} and the {tabletype} itself shown in the image. " + \
                            "### Special Requirements ###\n\n" + \
                            "1. Treat each item as a single entity; avoid breaking down objects into their components. For instance, mention a pot plant/flower as a whole object instead of listing its vase separately.\n\n" + \
                            "2. Maintain the integrity of composite objects. For example, refer to 'a vase' as a standalone description rather than specifying 'a vase of flowers'.\n\n" + \
                            "3. When captioning, please do not include walls, floors, windows and any items hung from the ceiling in your answer.\n\n" + \
                            f"4. When captioning, please do not include floor, chair, floor lamp, plants on the floor, beds or any other items on the floor, except for the {tabletype} in your answer.\n\n" + \
                            "5. When captioning, please do not include any objects below/inside the suppoter, such as cabinet/machine under the desk or book in the bookshelf.\n\n" + \
                            ...
                            "7. If the category of an object is unclear or rarely used in the scene, consider selecting a commonly recognized object or a widely used name for it. \n\n " +\
                            "8. Please do not add 's' or 'es' suffices to countable nouns. For example, you should caption multiple apples as 'apple', not 'apples'.\n\n" + \
                            f"9. Do not change the name of supporter, which is {tabletype}.\n\n"\
                            "Example output1: [table, banana, plate, candle]\n" + \
                            "Example output2: [desk, monitor, mouse, keyboard]\n" + \
                            "Example output4: [kitchen island, knife, seasoning, frying pan]\n\n\n"
