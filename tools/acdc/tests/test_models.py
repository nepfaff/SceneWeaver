...
def test_dinov2(args):
    ...
    encoder.get_features(img,"fridge")
...
def test_gpt(args):
    ...
    obj_caption_prompt_payload = gpt.payload_get_object_caption(img_path=TEST_IMG_PATH,tabletype="fridge")
...
def test_fm(args):
    ...
    model_results = fm.find_nearest_neighbor_candidates(
        ...
        candidate_imgs=["/home/yandan/workspace/digital-cousins/tests/fridge1.jpg"],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gpt_api_key", type=str, default=None,required=False,
    ...
    if args.gpt_api_key is None:
        with open("key.txt","r") as f:
            lines = f.readlines()
        args.gpt_api_key = lines[0].strip()
